...
{ 
public class UDPTunnel : IKeyHandler
{


    private const string TAG = UDPTunnel.class.getSimpleName();
private VpnService vpnService;
    private Selector selector;
    private UDPServer vpnServer;
...
private final NatSession session;
    ...
    public UDPTunnel(VpnService vpnService, Selector selector, UDPServer vpnServer, Packet packet, Queue<Packet> outputQueue, short portKey, Context context)
{
