...
namespace GFVPN.Service
{ 
public class FirewallVpnService : VpnService, IRunnable
{
    public const string ACTION_START_VPN = "com.fqxd.gftools.START_VPN";
    public const string ACTION_CLOSE_VPN = "com.fqxd.gftools.roav.CLOSE_VPN";
    private const string FACEBOOK_APP = "com.facebook.katana";
    private const string YOUTUBE_APP = "com.google.android.youtube";
    private const string GOOGLE_MAP_APP = "com.google.android.apps.maps";
    ...
    private const string GOOGLE_DNS_FIRST = "8.8.8.8";
    private const string GOOGLE_DNS_SECOND = "8.8.4.4";
    private const string AMERICA = "208.67.222.222";
    private const string HK_DNS_SECOND = "205.252.144.228";
    private const string CHINA_DNS_FIRST = "114.114.114.114";
    public const string BROADCAST_VPN_STATE = "com.fqxd.gftools.localvpn.VPN_STATE";
    public const string SELECT_PACKAGE_ID = "select_protect_package_id";
    private const string TAG = "FirewallVpnService";
...
public const int MUTE_SIZE = 2560;
